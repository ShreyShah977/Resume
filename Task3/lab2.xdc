...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {p}];  # "LD0"
...
set_property PACKAGE_PIN V22 [get_ports {Q[0]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {Q[1]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {Q[2]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {Q[3]}];  # "LD7"
...
#set_property PACKAGE_PIN N15 [get_ports {CLK}];  # "BTNL"
#set_property IOSTANDARD LVCMOS33 [get_ports{CLK}]
set_property PACKAGE_PIN R18 [get_ports {CLR}];  # "BTNR"
